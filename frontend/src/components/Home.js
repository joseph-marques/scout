  ...
  return (
    <div classNameName="flex flex-col items-center bg-black w-full h-full">
      ...
      <div class="relative bg-white overflow-hidden">
        <div className="relative z-10 bg-white lg:max-w-xl lg:w-full">
          <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="sm:text-center lg:text-left py-20">
              ...
              <div className="mt-5 sm:mt-8 flex content-center justify-center lg:justify-start">
                <Link
                  to="/signup"
        ...
        <div className="lg:absolute lg:bottom-0 lg:right-0 lg:w-1/2">
          <img
            src={mentorImage}
            alt=""
